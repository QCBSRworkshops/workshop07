...
Peut être obtenu en utilisant la fonction `coefplot2()`de la librarie `coefplot2` :
<br><br>
--

.alert[![:faic](warning) Cette librarie n'est pas sur le CRAN! On utilise la librarie remotes pour l'installer à partir de GitHub]
