---
title: "Atelier 7: Modèles generales et generalisés à effets mixtes"
...
hist(fish.data$Fish_Length, xlab = "Length", main = "")
...
$$z = \frac{(x-\bar{x})}{\text{écart-type}(x)}$$
---
# Étape 1 - exploration des données
...
- `(1 + Z_Length | Lake)` effet aléatoire par lac à l'intercept et la pente (NB: (`Z_Length | Lake)` donne le même résultat)
