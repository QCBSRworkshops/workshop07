...
* Les données proviennent de tous les niveaux possibles d'un facteur (variable qualitative) où d'un prédicteur (variable quantitative).

* On souhaite émettre des conclusions à propos des niveaux du facteur d'où les données proviennent ou de la relation entre le prédicteur et la variable réponse.
