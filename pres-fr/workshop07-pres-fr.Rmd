...
* Permet d'estimer le % de variation dans la variable réponse qui est expliqué par l'effet aléatoire
...
---
# Comment modéliser un GLMM sous R
...
.alert[Le rapport est maintenant beaucoup plus près de 1 mais la valeur de p < 0.05]
