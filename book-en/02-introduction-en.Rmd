...
For our first challenge, reproduce plots 1-3 using the script below and the Fish dataset. Observe each plot and try to get a sense of what is occurring. A few key questions to ask yourself are:
