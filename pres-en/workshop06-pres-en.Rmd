---
title: "Workshop 6: Linear mixed models (LMM)"
...
list.of.packages <- c("ggplot2", "lme4", "AICcmodavg")
...
```{r, echo = FALSE}
library(ggplot2)
data <- read.csv('data/qcbs_w6_data.csv', stringsAsFactors = TRUE)
...
plot(lm.test.resid ~ as.factor(data$Fish_Species),
     xlab = "Species", ylab = "Standardized residuals")

abline(0, 0, lty = 2)

plot(lm.test.resid ~ as.factor(data$Lake),
