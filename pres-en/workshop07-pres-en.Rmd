...
Note: To determine if you have built the best mixed model based on your prior knowledge, you should compare this a priori model to other alternative models.
...
For more details see https://www.rdocumentation.org/packages/lme4/versions/1.1-27.1/topics/Arabidopsis
