...
In the literature on LMMs, we meet these terms frequently.
...
.alert[Note]: error bars are only shown for the fixed effects because `glmer()` doesn't model uncertainty for random effects.
...
Choose the method you will use to select your model :
.small[
```{r}
